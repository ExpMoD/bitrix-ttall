...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2017-10-28 11:21:20','2017-10-29 00:00:00',NULL,86400,'Y',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2017-10-28 11:21:20','2017-10-29 00:00:00',NULL,86400,'Y',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2017-10-28 21:28:10','2017-10-28 22:28:10',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2017-10-28 11:21:20','2017-10-29 00:00:00',NULL,86400,'Y',NULL,'N'),(5,'main',100,'CSiteCheckerTest::CommonTest();','Y','2017-10-28 11:21:20','2017-10-29 11:21:20',NULL,86400,'N',NULL,'N'),(6,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2017-10-28 21:34:33','2017-10-28 21:35:33',NULL,60,'N',NULL,'N'),(7,'forum',100,'CForumStat::CleanUp();','Y','2017-10-28 17:40:06','2017-10-29 17:40:06',NULL,86400,'N',NULL,'N'),(8,'forum',100,'CForumFiles::CleanUp();','Y','2017-10-28 17:40:06','2017-10-29 17:40:06',NULL,86400,'N',NULL,'N'),(9,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2017-10-28 17:40:07','2017-10-29 17:40:07',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2017-10-28 17:40:07','2017-10-29 17:40:07',NULL,86400,'N',NULL,'N'),(11,'security',100,'CSecuritySession::CleanUpAgent();','Y','2017-10-28 21:23:52','2017-10-28 21:53:52',NULL,1800,'N',NULL,'N'),(12,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2017-10-28 21:28:10','2017-10-28 22:28:10',NULL,3600,'N',NULL,'N'),(13,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2017-10-28 21:28:10','2017-10-28 22:28:10',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2017-10-28 17:40:06','2017-10-29 17:40:06',NULL,86400,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2017-10-28 21:28:10','2017-10-28 22:28:10',NULL,3600,'N',NULL,'N'),(16,'subscribe',100,'CSubscription::CleanUp();','Y','2017-10-28 11:21:21','2017-10-29 03:00:00',NULL,86400,'Y',NULL,'N'),(32,'main',100,'\\Bitrix\\Main\\Data\\CacheEngineFiles::delayedDelete(1);','Y','2017-10-28 21:35:04','2017-10-28 00:00:03',NULL,1,'Y',NULL,'N');
...
INSERT INTO `b_iblock_element_iprop` VALUES (5,0,36,4,'Отзыв – Тестовый отзыв – Простая'),(5,0,33,2,'лучшие, отзывы, CTC-Медиа'),(5,0,33,3,'Вы сможете организовать внутри компании коллективную работу над проектами в рабочих группах, вести учет и планирование времени и событий, обмениваться сообщениями и почтой через портал, проводить внутри компании видеоконференции и делать многое другое.'),(5,0,33,4,'Отзыв – Cергей Родионов – CTC-Медиа'),(5,0,35,2,'лучшие, отзывы, .NET-девелопмент'),(5,0,35,3,'Можете сразу перейти с «младшей», базовой редакции на «Бизнес-процессы». После такого перехода ваш портал можно будет интегрировать с внешним сайтом, на портале добавятся возможности визуального проектирования бизнес-процессов и управления списками, включая списки в рабочих группах. Кроме того, вы сможете анализировать посещаемость своего портала'),(5,0,36,1,'Отзыв – Тестовый отзыв'),(5,0,36,2,'лучшие, отзывы, Простая'),(5,0,36,3,'Тестовый отзыв для демонстрации выдачи изображения no_photo при отсутствии его у в записи.'),(5,0,35,4,'Отзыв – Дмитрия Пялов – .NET-девелопмент'),(5,0,33,1,'Отзыв – Cергей Родионов'),(5,0,35,1,'Отзыв – Дмитрия Пялов');
...
INSERT INTO `b_iblock_group` VALUES (1,2,'R'),(1,1,'X'),(1,5,'W'),(2,2,'R'),(2,1,'X'),(2,5,'W'),(3,2,'R'),(3,1,'X'),(3,5,'W'),(4,2,'R'),(4,1,'X'),(4,5,'W'),(5,2,'R'),(5,1,'X');
...
INSERT INTO `b_iblock_messages` VALUES (1,'ELEMENT_NAME','Новость'),(1,'ELEMENTS_NAME','Новости'),(1,'ELEMENT_ADD','Добавить новость'),(1,'ELEMENT_EDIT','Изменить новость'),(1,'ELEMENT_DELETE','Удалить новость'),(1,'SECTION_NAME','Раздел'),(1,'SECTIONS_NAME','Разделы'),(1,'SECTION_ADD','Добавить раздел'),(1,'SECTION_EDIT','Изменить раздел'),(1,'SECTION_DELETE','Удалить раздел'),(2,'ELEMENT_NAME','Элемент'),(2,'ELEMENTS_NAME','Товары'),(2,'ELEMENT_ADD','Добавить товар'),(2,'ELEMENT_EDIT','Изменить товар'),(2,'ELEMENT_DELETE','Удалить товар'),(2,'SECTION_NAME','Раздел'),(2,'SECTIONS_NAME','Разделы'),(2,'SECTION_ADD','Добавить раздел'),(2,'SECTION_EDIT','Изменить раздел'),(2,'SECTION_DELETE','Удалить раздел'),(3,'ELEMENT_NAME','Услуга'),(3,'ELEMENTS_NAME','Услуги'),(3,'ELEMENT_ADD','Добавить услугу'),(3,'ELEMENT_EDIT','Изменить услугу'),(3,'ELEMENT_DELETE','Удалить услугу'),(3,'SECTION_NAME','Раздел'),(3,'SECTIONS_NAME','Разделы'),(3,'SECTION_ADD','Добавить раздел'),(3,'SECTION_EDIT','Изменить раздел'),(3,'SECTION_DELETE','Удалить раздел'),(4,'ELEMENT_NAME','Вакансия'),(4,'ELEMENTS_NAME','Вакансии'),(4,'ELEMENT_ADD','Добавить вакансию'),(4,'ELEMENT_EDIT','Изменить вакансию'),(4,'ELEMENT_DELETE','Удалить вакансию'),(4,'SECTION_NAME','Раздел'),(4,'SECTIONS_NAME','Разделы'),(4,'SECTION_ADD','Добавить раздел'),(4,'SECTION_EDIT','Изменить раздел'),(4,'SECTION_DELETE','Удалить раздел'),(5,'SECTION_DELETE','Удалить раздел'),(5,'SECTION_EDIT','Изменить раздел'),(5,'SECTIONS_NAME','Разделы'),(5,'ELEMENT_ADD','Добавить элемент'),(5,'ELEMENT_EDIT','Изменить элемент'),(5,'SECTION_ADD','Добавить раздел'),(5,'SECTION_NAME','Раздел'),(5,'ELEMENT_DELETE','Удалить элемент'),(5,'ELEMENTS_NAME','Элементы'),(5,'ELEMENT_NAME','Элемент');
...
',0,'СИТИ'),(34,'s1',0,'СОБРАНИЕ'),(16,'s1',29,'СОЕДИНЕНИЕ'),(50,'s1',8,'СОТРУДНИЧЕСТВА'),(51,'s1',4,'СТАТЬ'),(54,'s1',6,'СТРАНИЦА'),(55,'s1',6,'СТРАНИЦА'),(4,'s1',9,'СТРАТЕГИЯ'),(60,'s1',0,'ТЕСТОВЫЙ'),(50,'s1',0,'УСЛОВИЯ'),(12,'s1',0,'УСЛУГИ'),(46,'s1',0,'УСЛУГИ'),(49,'s1',17,'УЧЕТА'),(41,'s1',0,'ФАЗЕНДА'),(29,'s1',0,'ФЛОРА'),(14,'s1',10,'ФОРУМ'),(24,'s1',0,'ХРОМ'),(44,'s1',9,'ХРОМ'),(42,'s1',0,'ЭРА');
...
INSERT INTO `b_user` VALUES (1,NULL,'admin','E9QY22EP21d76e022300ca8cefb202d8e312b96b','jA2pQp5U48daa6b8cb1aad4a1a2fc7e1b6c811c2','Y','Андрей','Кудаков','kudakovandrey@gmail.com','2017-10-28 21:17:14','2017-10-27 17:23:28',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-10-27 17:23:28',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `b_user_option` VALUES (1,0,'intranet','~gadgets_admin_index','a:1:{i:0;a:1:{s:7:\"GADGETS\";a:8:{s:20:\"ADMIN_INFO@333333333\";a:3:{s:6:\"COLUMN\";i:0;s:3:\"ROW\";i:0;s:4:\"HIDE\";s:1:\"N\";}s:19:\"HTML_AREA@444444444\";a:5:{s:6:\"COLUMN\";i:0;s:3:\"ROW\";i:1;s:4:\"HIDE\";s:1:\"N\";s:8:\"USERDATA\";a:1:{s:7:\"content\";s:797:\"<table class=\"bx-gadgets-info-site-table\" cellspacing=\"0\"><tr>	<td class=\"bx-gadget-gray\">Создатель сайта:</td>	<td>Группа компаний &laquo;1С-Битрикс&raquo;.</td>	<td class=\"bx-gadgets-info-site-logo\" rowspan=\"5\"><img src=\"/bitrix/components/bitrix/desktop/templates/admin/images/site_logo.png\"></td></tr><tr>	<td class=\"bx-gadget-gray\">Адрес сайта:</td>	<td><a href=\"http://www.1c-bitrix.ru\">www.1c-bitrix.ru</a></td></tr><tr>	<td class=\"bx-gadget-gray\">Сайт сдан:</td>	<td>12 декабря 2010 г.</td></tr><tr>	<td class=\"bx-gadget-gray\">Ответственное лицо:</td>	<td>Иван Иванов</td></tr><tr>	<td class=\"bx-gadget-gray\">E-mail:</td>	<td><a href=\"mailto:info@1c-bitrix.ru\">info@1c-bitrix.ru</a></td></tr></table>\";}s:8:\"SETTINGS\";a:1:{s:9:\"TITLE_STD\";s:34:\"Информация о сайте\";}}s:25:\"ADMIN_CHECKLIST@777888999\";a:3:{s:6:\"COLUMN\";i:0;s:3:\"ROW\";i:2;s:4:\"HIDE\";s:1:\"N\";}s:19:\"RSSREADER@777777777\";a:4:{s:6:\"COLUMN\";i:1;s:3:\"ROW\";i:3;s:4:\"HIDE\";s:1:\"N\";s:8:\"SETTINGS\";a:3:{s:9:\"TITLE_STD\";s:33:\"Новости 1С-Битрикс\";s:3:\"CNT\";i:10;s:7:\"RSS_URL\";s:45:\"https://www.1c-bitrix.ru/about/life/news/rss/\";}}s:24:\"ADMIN_SECURITY@555555555\";a:3:{s:6:\"COLUMN\";i:1;s:3:\"ROW\";i:0;s:4:\"HIDE\";s:1:\"N\";}s:25:\"ADMIN_SITESPEED@666666777\";a:3:{s:6:\"COLUMN\";i:1;s:3:\"ROW\";i:1;s:4:\"HIDE\";s:1:\"N\";}s:23:\"ADMIN_PERFMON@666666666\";a:3:{s:6:\"COLUMN\";i:1;s:3:\"ROW\";i:2;s:4:\"HIDE\";s:1:\"N\";}s:23:\"ADMIN_MARKETPALCE@22549\";a:3:{s:6:\"COLUMN\";i:1;s:3:\"ROW\";i:3;s:4:\"HIDE\";s:1:\"N\";}}}}','Y'),(2,0,'main.interface','global','a:1:{s:5:\"theme\";s:4:\"blue\";}','Y'),(3,1,'admin_panel','settings','a:1:{s:4:\"edit\";s:2:\"on\";}','N'),(4,1,'hot_keys','user_defined','b:1;','N'),(5,1,'favorite','favorite_menu','a:1:{s:5:\"stick\";s:1:\"N\";}','N'),(6,1,'main','helper_hero_admin','a:1:{s:4:\"time\";s:10:\"1509214729\";}','N'),(7,1,'socialservices','networkPopup','a:1:{s:9:\"showcount\";s:1:\"2\";}','N'),(8,1,'admin_menu','pos','a:1:{s:8:\"sections\";s:158:\"menu_system,menu_module_settings,menu_site,menu_fileman,menu_fileman_file_s1_,menu_iblock,iblock_admin,iblock_import,menu_iblock_/rews,menu_iblock_%2Frews%2F5\";}','N'),(9,1,'fileman','file_dialog_config','s:47:\"s1;/materials/demo-content-iblock;list;type;asc\";','N'),(10,1,'access_dialog_recent','other','a:2:{i:0;s:2:\"AU\";i:1;s:2:\"G2\";}','N'),(11,1,'html_editor','user_settings_','a:2:{s:13:\"taskbar_shown\";s:1:\"1\";s:4:\"view\";s:7:\"wysiwyg\";}','N'),(12,1,'form','form_element_5','a:1:{s:4:\"tabs\";s:1763:\"cedit1--#--Общие--,--ACTIVE--#--Активность--,--ACTIVE_FROM--#--Начало активности--,--NAME--#--*Название--,--CODE--#--Символьный код--,--PROPERTY_9--#--Должность--,--PROPERTY_10--#--Компания--;--cedit2--#--Второстепенные--,--PREVIEW_PICTURE--#--Картинка для анонса--,--PREVIEW_TEXT--#--Описание для анонса--,--DETAIL_PICTURE--#--Детальная картинка--,--DETAIL_TEXT--#--Детальное описание--,--PROPERTY_11--#--Документы--;--edit14--#--SEO--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--Шаблон META TITLE--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--Шаблон META KEYWORDS--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--Шаблон META DESCRIPTION--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--Заголовок элемента--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#----Настройки для картинок анонса элементов--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--Шаблон ALT--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--Шаблон TITLE--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--Шаблон имени файла--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#----Настройки для детальных картинок элементов--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--Шаблон ALT--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--Шаблон TITLE--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--Шаблон имени файла--,--SEO_ADDITIONAL--#----Дополнительно--,--TAGS--#--Теги--;--\";}','N');
...
INSERT INTO `b_user_stored_auth` VALUES (1,1,'2017-10-27 17:23:28','2017-10-28 21:17:14','e7fe8c8ff8bed6db55e225a90b679b9c','N',2130706433);
...
-- Dump completed on 2017-10-28 21:35:19
